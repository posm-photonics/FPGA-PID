...
## Switches
set_property PACKAGE_PIN V17 [get_ports {Mplier_in[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mplier_in[0]}]
set_property PACKAGE_PIN V16 [get_ports {Mplier_in[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mplier_in[1]}]
set_property PACKAGE_PIN W16 [get_ports {Mplier_in[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mplier_in[2]}]
set_property PACKAGE_PIN W17 [get_ports {Mplier_in[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mplier_in[3]}]
set_property PACKAGE_PIN W15 [get_ports {Mplier_in[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mplier_in[4]}]
set_property PACKAGE_PIN V15 [get_ports {Mplier_in[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mplier_in[5]}]
set_property PACKAGE_PIN W14 [get_ports {Mplier_in[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mplier_in[6]}]
set_property PACKAGE_PIN W13 [get_ports {Mplier_in[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mplier_in[7]}]
set_property PACKAGE_PIN V2 [get_ports {Mcand_in[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mcand_in[0]}]
set_property PACKAGE_PIN T3 [get_ports {Mcand_in[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mcand_in[1]}]
set_property PACKAGE_PIN T2 [get_ports {Mcand_in[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mcand_in[2]}]
set_property PACKAGE_PIN R3 [get_ports {Mcand_in[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mcand_in[3]}]
set_property PACKAGE_PIN W2 [get_ports {Mcand_in[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mcand_in[4]}]
set_property PACKAGE_PIN U1 [get_ports {Mcand_in[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mcand_in[5]}]
set_property PACKAGE_PIN T1 [get_ports {Mcand_in[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mcand_in[6]}]
set_property PACKAGE_PIN R2 [get_ports {Mcand_in[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Mcand_in[7]}]
...
##Pmod Header JA
##Sch name = JA1
#set_property PACKAGE_PIN J1 [get_ports {G1}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {G1}]
##Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {Y1}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Y1}]
##Sch name = JA3
#set_property PACKAGE_PIN J2 [get_ports {R1}]					
...
##Sch name = JA7
#set_property PACKAGE_PIN H1 [get_ports {Y2}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Y2}]
##Sch name = JA8
#set_property PACKAGE_PIN K2 [get_ports {R2}]					
