# ============================================================================
# vivado/build_posm_red_pitaya.tcl
# ============================================================================
#
...
# top/red_pitaya_lock_core.py's module docstring for why.
#
...
#
#   3. Manually added ONE instantiation of posm_lock_core into
...
#
# USAGE:
#   vivado -mode batch -source vivado/build_posm_red_pitaya.tcl \
#          -tclargs <path-to-RedPitaya-FPGA-repo>
#
# OUTPUT:
#   vivado/build/posm_red_pitaya.runs/impl_1/red_pitaya_top.bit
#
# The resulting .bit still needs converting to .bin for Red Pitaya OS to
...
set constraints [file join $repo_root "constraints" "RedPitaya_125-14.xdc"]
...
# already contain the posm_lock_core instantiation described above.
# ---------------------------------------------------------------------------
...
puts "official Makefile's bit2bin step), then load with overlay.sh / fpgautil."