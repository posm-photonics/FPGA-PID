...
from rtl.bus.register_defs import ADDR_CONTROL, ADDR_MODE, ADDR_TRACE_CONFIG, 
ADDR_TRACE_LENGTH, ADDR_TRACE_START, ADDR_SLOW_CTRL_CONFIG, ADDR_SLOW_RECENTER_TARGET, 
ADDR_SLOW_RECENTER_GAIN, ADDR_SLOW_OUT_MIN, ADDR_SLOW_OUT_MAX, ADDR_SLOW_OUT_SAFE, 
ADDR_SLOW_BIAS, ADDR_FAULT_ENABLE, ADDR_FAULT_CLEAR, CTRL_GLOBAL_ENABLE, 
CTRL_LOCK_ENABLE_REQUEST, CTRL_TRACE_CAPTURE_ENABLE, CTRL_AUTOLOCK_ENABLE, 
